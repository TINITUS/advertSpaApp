...
advertsApp.controller('homeCtrl', ['$scope','$http','baseUrl', 'userData', 'authService', 'growl', 'adsFilter', function($scope, $http, baseUrl, userData, authService, growl, adsFilter){
	var self = $scope;
	self.pageTitle = "Home";
